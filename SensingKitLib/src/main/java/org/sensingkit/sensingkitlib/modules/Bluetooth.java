...
import org.sensingkit.sensingkitlib.model.data.BluetoothData;

public class Bluetooth extends AbstractSensorModule {
    ...
    protected Bluetooth(Context context) throws SKException {
        super(context, SensorModuleType.BLUETOOTH);
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {  // Device Found
                ...
                AbstractData data = new BluetoothData(System.currentTimeMillis());
