...
public class AudioRecorder extends AbstractSensorModule {
    ...
    public AudioRecorder(final Context context) throws SKException {
        super(context, SensorModuleType.AUDIO_RECORDER);
