...
public final class SKUtilities {
    ...
    static boolean isGooglePlayServicesAvailable(final @NonNull Context context) {
     ...
     */
    static @NonNull String csvHeaderForSensor(final SKSensorType sensorType) {
     ...
     */
    static boolean isSensorAvailable(final SKSensorType sensorType, final @NonNull Context context) {
